...
import "./admin/components/pdf-generator.component.scss";

import Table from "./admin/components/table";
import Pie_Chart from "./admin/components/pie_chart";
import Bar_Chart from "./admin/components/bar_chart";

import download_pdf from "./admin/utils/generate_pdf";
...
function PdfGeneratorComponent() {
  ...
  async function fetch() {
    ...
    const users = await context.query.PDF_Item_2.findMany();
    console.log(users);
  }
